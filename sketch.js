...
function setup() {
	...
	bobObject1 = new Bob(860,500);
	bobObject2 = new Bob(900,500);
	bobObject3 = new Bob(940,500);
	bobObject4 = new Bob(980,500);
	bobObject5 = new Bob(1020,500);

	roofObject = new Roof(940,300,220,20);
